...
export function searchForBestDeal(productName) {
    ...
    setTimeout(() => {
        ...
        // Hide loading and show deal
        hideLoadingAnimation();
        displayBestDeal(simulatedBestDeal);
    }, 2000);
}

// Function to display the best deal popup (triggered by CartViser panel)
...
// Make sure to export the main function for CartViser to trigger it.
export { displayBestDeal };
